...
import { ArrowUp, ChevronUp, CircleArrowUp, Play, Triangle } from 'lucide-react'
  ...
  return (
    <div className={cn('admin-main p-4', className)}>
      <div className='flex flex-row gap-1 items-center'>
        ...
        <Triangle fill='currentColor' width={12} height={12} className={cn('ml-2', telorance > 0 ? 'text-green-500' : 'text-red-500 rotate-180')} />
